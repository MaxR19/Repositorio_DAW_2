...
function mostrarCapital($pais){
    ...
    foreach ($capitales as $capitalP) {
        if ($capitalP->pais === $pais) {
            $capitalPais=$capitalP->capital;
            break;
        }
    } 
    return $capitalPais;
...
$sHtml.="   <th><b>Número de habitantes</b></th>";
$sHtml.="</tr>";
...
foreach ($paises as $pais) {
    ...
    foreach ($capitales as $capital) {
        if ($pais->nombre === $capital->pais) {
            
            //Vamos añadiendo fila a fila
            $sHtml.="<tr>";
            $sHtml.="   <td>". $pais->nombre ."</td>";
            $sHtml.="   <td>".strval($capital->capital)."</td>";
...
foreach ($paises as $pais) {
    ...
    $capitalPais=mostrarCapital($pais->nombre);

    //Vamos añadiendo fila a fila
        $sHtml.="<tr>";
        $sHtml.="   <td>". $pais->nombre ."</td>";
        $sHtml.="   <td>". $capitalPais."</td>";
        $sHtml.="   <td>". strval($pais->habitantes)."</td>";
        $sHtml.="</tr>";
}
